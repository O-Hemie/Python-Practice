...
print(logo)
print('Rule of the game: The card has been reshuffled. The player(you) gets two random cards, you play against the dealer(computer) who shows you only its first card. If you have a K, Q, or J their value is equivalent to 10. if you have an Ace "A", depending on the sum of your cards A can stand as 1 or 11. Get your sum of cards to be as close to 21 as possible by choosing to hit or stand after seeing your cards(Cards are chosen at random. NOTE: Avoid getting a sum that is more than 21 or you get bursted and lose. You only get one chance to hit or stand. Have fun!')
